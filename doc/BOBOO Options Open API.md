...
The base url of BOBOO open API is: https://www.boboo.com/openapi
...
In the `symbols` field, the endpoint will return information on current actively trading cryptos on BOBOO. You can ignore this section.
