...
import io.boboo.api.client.domain.account.SocketAccount;
import io.boboo.api.client.domain.account.SocketOrder;
 ...
 */
public class BobooApiWebSocketUserListener<T> extends WebSocketListener {
    ...
    public BobooApiWebSocketUserListener(BobooApiCallback<T> callback) {
    ...
    public void onMessage(WebSocket webSocket, String text) {
        ...
        try {
            ...
            if (jsonNode.isArray()) {
                ...
                JsonNode pingNode = jsonNode.get(BobooConstants.PING_MSG_KEY);
                if (pingNode != null) {
                    pingTime = pingNode.asLong();
                    pingMap.put(BobooConstants.PONG_MSG_KEY, System.currentTimeMillis());
